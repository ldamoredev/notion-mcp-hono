...
const pages = [
  {
    ...
    markdown: [
      '# Welcome',
      '',
      'This is the **demo workspace** for [notion-mcp-hono](https://example.com) — with `inline code` and *emphasis*.',
      '',
      '## What to try',
      '',
      '1. Run `search_pages` with a query',
      '2. Open a result with `get_page`',
      '',
      '- [x] Deploy to Railway',
      '- [ ] Write the case study',
      '',
      '> Read-only tools, a dedicated workspace, a rate limit per visitor.',
      '',
      '```bash',
