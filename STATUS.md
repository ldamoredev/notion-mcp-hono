...
| 3 | Auth middleware: bearer token, timing-safe compare, tests | 🔄 next | |
| 4 | Notion layer: client wrapper + markdown conversion, tested | ⬜ pending | |
| 5 | The 5 tools, TDD, one at a time | ⬜ pending | search_pages, get_page, create_page, append_blocks, query_database |
